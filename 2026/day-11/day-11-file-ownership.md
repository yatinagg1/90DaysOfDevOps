...
Changing ownership of file does not transfer group too, it remains the previous one until explicitly been changed
...
Group change only changes group but owner of the fiile remained the previous one.

Command used is chgrp
---
...
chown is the command to change ownership and group in single command as syntax below
...
Single space does matter, be careful while executing the command.
